...
{
	TransparentBlt(hdc, x, y, m_size.cx, m_size.cy, m_hMemDC, 0, 0, IMAGE_WIDTH, IMAGE_HEIGHT, RGB(255, 0, 255));

}

void Bitmap::BackDraw(HDC hdc, int x, int y)
{
	TransparentBlt(hdc, x, y, m_size.cx, m_size.cy, m_hMemDC, 0, 0, MAPIMAGE_WIDTH, MAPIMAGE_HEIGHT, RGB(255, 0, 255));

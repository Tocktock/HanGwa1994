...
void Bitmap::BackDraw(HDC hdc, int x, int y, int objWidth, int objHegiht)
{
	TransparentBlt(hdc, x, y, objWidth, objHegiht, m_hMemDC, 0, 0, m_size.cx, m_size.cy, RGB(255, 0, 255));

...
{
	AdjustAnchor(x, y);
	TransparentBlt(ResourceManager::GetInstance()->GetBackDC(), x, y,
		m_size.cx, m_size.cy, m_hMemDC, 0, 0, m_size.cx, m_size.cy, RGB(255, 0, 255));
...
{
	AdjustAnchor(x, y);
	TransparentBlt(ResourceManager::GetInstance()->GetBackDC(), 
		x, y, AdjustX, AdjustY, m_hMemDC, 0, 0, m_size.cx, m_size.cy, RGB(255, 0, 255));
}
